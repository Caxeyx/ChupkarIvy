...
use chupkarivy_player::{info::PlaybackInfo, PlayerHandle};
...
fn build_embed(playback_info: &PlaybackInfo, owner: &User) -> CreateEmbed {
    ...
    description += &format!(
        "{} / {}",
        chupkarivy_utils::time_to_string(position / 1000),
        chupkarivy_utils::time_to_string(playback_info.duration() / 1000)
    );
