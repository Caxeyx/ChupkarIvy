...
/// The "listening to" message that shows up under the ChupkarIvy bot user
pub const MOTD: &str = "some good 'ol music";

/// The time it takes (in seconds) for ChupkarIvy to disconnect when no music is being played
